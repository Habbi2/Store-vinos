        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-6">
                    <div class="white-box text-center "><img src={contenido.image} class="img-responsive"/></div>
                </div>
            ...
            <h3 class="card-subtitle d-flex">{contenido.cellar}</h3>
                    ...
                    <button class="btn btn-dark btn-rounded me-4" data-toggle="tooltip" title="" data-original-title="Add to cart">
                        <i class="fa fa-shopping-cart cart"></i>
                    </button>
                    <button class="btn btn-rounded btn-buy"><strong>COMPRAR</strong></button>
                    <h3 class="box-title mt-5">VALORACION</h3>
                    <ul class="list-unstyled">
                        <li><i class="fa fa-check text-success"></i>muy bueno</li>
                        <li><i class="fa fa-check text-success"></i>pega como coto</li>
                        <li><i class="fa fa-check text-success"></i>muy bueno</li>
                    </ul>
                </div>
            </div>
